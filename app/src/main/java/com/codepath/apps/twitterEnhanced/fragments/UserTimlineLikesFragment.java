...
public class UserTimlineLikesFragment extends UserTimelineFragment {
    ...
    public static UserTimlineLikesFragment newInstance(String screenName) {
        UserTimlineLikesFragment userTimlineLikesFragment = new UserTimlineLikesFragment();
        Bundle args = new Bundle();
        args.putString("screen_name", screenName);
        userTimlineLikesFragment.setArguments(args);
        return userTimlineLikesFragment;
    }
