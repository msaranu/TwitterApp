...
public class UserListFollowingFragment extends TimelineFragment {
    ...
    public static UserListFollowingFragment newInstance(String screenName) {
        UserListFollowingFragment userListFollowingFragment = new UserListFollowingFragment();
        Bundle args = new Bundle();
        args.putString("screen_name", screenName);
        userListFollowingFragment.setArguments(args);
        return userListFollowingFragment;
    }
