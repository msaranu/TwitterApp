...
public class UserTimelineMediaFragment extends UserTimelineFragment{

        private TwitterClient client;


    public static UserTimelineMediaFragment newInstance(String screenName) {
        ...
        protected void populateTimeline(int page) {
            ...
            client.getUserTimelinePhotos(new JsonHttpResponseHandler() {
                @Override
